...
function PhotosEditor({ images, authToken, setRefresh, wellnessId }: PhotoProps) {
    ...
    async function removePhoto(ev: any, id: string) {
        ...
        try {
            ...
            await axios.delete('/wellness/delete_image/', {
                data: formData,
                headers: {
                    Authorization: `Bearer ${authToken}`, // Include your authentication token
                },
    ...
    const selectAsMainPhoto = async (ev: any, id: string) => {
        ...
        try {
            const { data } = await axios.patch(`/wellness/${wellnessId}/is_main_image/`, formdata, {
                headers: {
                    Authorization: `Bearer ${authToken}`, // Include your authentication token
                },
            })
