...
function PhotosEditor({ images, authToken, setRefresh, treatmentId }: PhotoProps) {
    ...
    async function removePhoto(ev: any, id: string) {
        ...
        try {
            ...
            await axios.delete('/treatment/delete_image/', {
                data: formData,
                headers: {
                    Authorization: `Bearer ${authToken}`, // Include your authentication token
                },
    ...
    const selectAsMainPhoto = async (ev: any, id: string) => {
        ...
        try {
            const { data } = await axios.patch(`/treatment/${treatmentId}/is_main_image/`, formdata, {
                headers: {
                    Authorization: `Bearer ${authToken}`, // Include your authentication token
                },
            })
